      ...
      <li class="list site">
        ...
        <div class="subContainer">
          <dl class="hotel">
            ...
            <dd>
              <router-link to="/">公寓豪华酒店</router-link>
            </dd>
            <dd>
              <router-link to="/">旅社度假酒店</router-link>
            </dd>
            <dd>
          ...
          <dl class="app">
            <dt>手机应用</dt>
            <dd>
              <router-link to="/"><img src="//s0.meituan.net/bs/fe-web-meituan/2d53095/img/appicons/meituan.png" title="美团app" alt="美团app"></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/waimai.png" title="美团app" alt="美团app"></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s0.meituan.net/bs/fe-web-meituan/404d350/img/appicons/zhenguo.png" title="榛果app" alt="榛果app"></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/dianping.png" title="点评app" alt="点评app"></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/maoyan.png" title="猫眼app" alt="猫眼app"></router-link>
            </dd>
          </dl>
        </div>
      </li>
